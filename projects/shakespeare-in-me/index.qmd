...
description: "In this project, we implement transformers from scratch to create our own GPT that sounds like Shakespeare."
---
...
**GitHub Repository**  
For more details, the full source code can be found on GitHub: [Source Code](https://github.com/vikrantmehta123/makemore/blob/main/gpt/gpt.ipynb)

And for a curious reading, the output could be found here: [more.txt](https://github.com/vikrantmehta123/makemore/blob/main/gpt/more.txt)
